...
have became slower compared to the single LAN case, and in fact random
scheduling is now visibly worse than immediate; while unicast seems
to be unaffected by the presence of routers.  However, the overall effect
of scheduling on multicast is still less than on unicast.
...
It may therefore happen that multicast (with random scheduling) becomes slightly
faster by increasing the number of clients!  Obviously, a future experiment
