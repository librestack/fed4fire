...
and use the experience gained here to design future experiments which
...
director0 and specifying a ``rsync'' destination where it will copy
...
director0$ ./run-experiment --rsync DESTINATION
\end{verbatim}
\end{small}

The destination must be set up as appropriate to receive the data.
Other options to ``{\tt run-experiment}'' are normally not required;
...
\bibitem{data}
  Calvelli, C, Payne, E, and Sheffield, B. (2022).
  {\em Librecast: IoT Software Updates over IPv6 Multicast Archive of all experimental data [Data set].}
  Zenodo.\\ \url{https://doi.org/10.5281/zenodo.6382741}

\bibitem{exp:scripts}
  Calvelli, C, Payne, E, and Sheffield, B. (2022).
  {\em Fed4fire experiment setup scripts}.\\
  \url{https://github.com/librestack/fed4fire}
